...
namespace Speckoz.BukkitDev._dep.SQLite
{
    ...
    internal class CriarBanco
    {
        ...
        private const string CriarTabelaInserirDados = @"create table ftp(host varchar(30), usuario varchar(100), senha varchar(100), porta varchar(5), tipo varchar(10));
			...
			insert into mysql(servidor, usuario, senha, porta, banco, tipo) values ('localhost', 'root', 'root', '3306', 'BukkitDev', 'Externo'); 
			insert into mysql(servidor, usuario, senha, porta, banco, tipo) values ('localhost', 'root', 'root', '3306', 'BukkitDev', 'Local');";
        #endregion
        /// <summary>
